      ...
      <main className="flex flex-1 flex-col items-center p-4 sm:p-6 md:p-8">
        <div className="w-full max-w-4xl space-y-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {remedies.map(remedy => (
                 <Card key={remedy.name} className="shadow-lg hover:shadow-xl transition-shadow duration-300">
                    <CardHeader>
                        <CardTitle className="flex items-center gap-2 font-headline text-2xl">
                           <Leaf className="text-primary"/> {remedy.name}
                        </CardTitle>
                        <CardDescription className="pt-2 text-base">{remedy.benefit}</CardDescription>
                    </CardHeader>
                    <CardContent>
                                ...
                                <AccordionContent>
                                    <div className="space-y-4">
                                        <div>
                                            ...
                                            <p className="text-muted-foreground">{remedy.usage}</p>
                                        </div>
                                         <div>
                                            <h4 className="font-semibold flex items-center gap-2 text-destructive/80"><AlertTriangle className="w-4 h-4"/>Precautions</h4>
                                            <p className="text-muted-foreground">{remedy.precautions}</p>
                                        </div>
                                    </div>
                                </AccordionContent>
                            </AccordionItem>
